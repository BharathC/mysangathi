               ...
               <div class="col-md-9 col-md-offset-1"> <center>
                       <div class="panel panel-success">
                          <div class="panel-heading">
                            <h3 class="panel-title "><span class="text-danger">Thank You</span></h3>
                          </div>
                          <div class="panel-body ">
                           Thank you for registering with <strong> MySangathi.com</strong>. Check your email to activate your account.    
                          </div>
                        </div>
                   </center>
               </div>
