...
<div id="container"  class="container ">	<!-- Container Starts-->
			...
			<div id="menu" class="row">	<!-- menu Starts-->	
				...
				<div id="content" class="row">  <!--Row1 content Starts -->
							    ...
							    <div class="col-md-3 col-md-push-8 col-sm-3 col-sm-push-8 thumbnail"> 
                                    ...
                                    <center>
                                      <button id=contactdetails><img class="img-responsive" src="images/arrow_down_double.png"></button>
										<div class="slidedetails" id="slidedetails">
									
									
										<h3>Contact Details</h3>
											Phone No:&nbsp;&nbsp;&nbsp;<s:property value="profile.phoneno" />
										<br />	<br />
										Mobile No:&nbsp;&nbsp;&nbsp;<s:property value="profile.mobileno" />
											<br />	<br />
										Email Id:&nbsp;&nbsp;&nbsp;<s:property value="profile.email" />
										<br />	<br />
                			...
                			<div class="col-md-7 col-md-pull-3 col-md-offset-1 col-sm-7 col-sm-pull-3 col-sm-offset-1"> <!-- basic info -->
                			<s:form theme="simple">
                              <table  border="0" class="table table-responsive table-striped table-hover table-condensed thumbnail">
                                            ...
                                            <tr>
                                              ...
                                              <td width="200" colspan="2">
                                              	<center><s:property value="profile.name"  /> </center>
                                              </td>
                                             
                                            </tr>
                                            <tr>
                                             <td ><h5 class="text-primary text-right">Date of Birth :</h5></td>
                                              <td colspan="2">	<center><s:property value="profile.dateofbirth"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                               <td><h5 class="text-primary text-right">Gender  :</h5></td> 
                                               <td colspan="2">	<center><s:property value="profile.gender"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                              <td><h5 class="text-primary text-right">Religion :</h5></td> 
                                              <td colspan="2">	<center><s:property value="profile.religion"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Caste :</h5></td> 
                                             <td colspan="2"><center><s:property value="profile.caste"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                              <td><h5 class="text-primary text-right">Sub Caste :</h5></td>
                                               <td colspan="2">	<center><s:property value="profile.subcaste"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                               <td><h5 class="text-primary text-right">Nakshatra :</h5></td>
                                                <td colspan="2"><center><s:property value="profile.nakshtra"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                              <td><h5 class="text-primary text-right">Rashi :</h5></td>
                                               <td colspan="2">	<center><s:property value="profile.rashi"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                              <td><h5 class="text-primary text-right">Marital Status :</h5></td>
                                               <td colspan="2">	<center><s:property value="profile.martialstatus"  /> </center></td>
                                            ...
                                            <tr>
                                             <td><h5 class="text-primary text-right">Qualification :</h5></td>
                                              <td colspan="2">	<center><s:property value="profile.education"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Profession :</h5></td> 
                                             <td colspan="2"><center><s:property value="profile.profession"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Name of the company :</h5></td> 
                                             <td colspan="2"><center><s:property value="profile.companyname"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Working country :</h5></td> 
                                             <td colspan="2"><center><s:property value="profile.countrylivingin"  /> </center></td>
                                            ...
                                            <tr>
                                              <td><h5 class="text-primary text-right">Father Name :</h5></td>
                                               <td colspan="2">	
                                               <center>
                                               		<s:property value="profile.fathername"  /> 
                                               </center></td>
                                            ...
                                            <tr>
                                             ...
                                             <td colspan="2">
                                             	<center><s:property value="profile.fatheroccupation"  /> </center>
                                             </td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Mother Name :</h5></td>
                                              <td colspan="2"><center><s:property value="profile.mothername"  /> </center></td>
                                             
                                            </tr>
                                            <tr>
                                             <td><h5 class="text-primary text-right">Mother Occupation :</h5></td>
                                             
                                              <td colspan="2"><center><s:property value="profile.motheroccupation"  /> </center></td>
                                            ...
                                            <tr>
                                             ...
                                             <td width="220"><h5 class="text-primary text-left">No of brothers :</h5>
                                             	<center><s:property value="profile.noofbrothers"  /> </center>
                                             </td>
                                             <td width="210"><h5 class="text-primary text-left">No of Sisters :</h5>
                                             	<center><s:property value="profile.noofsisters"  /> </center>
                                             </td>
                                            </tr>
                                          </table>
									</s:form>
                                         ...
                                         <table border="0" class="table table-responsive table-striped table-hover table-condensed thumbnail" >
                                              ...
                                              <tr>
                                                <td ><h5 class="text-primary text-right">Paid :</h5></td>
                                                <td colspan="2" ><s:checkbox name="paidstatus"   value="true" disabled="true" /></td>
                                              ...
                                              <tr>
                                                <td ><h5 class="text-primary text-right">Profile Status:</h5></td>
                                                <td colspan="2" >
                                                		<center>
 								...
 								<!--Admin Payment section if the member is not paid  -->
                                            ...
                                            <s:form action="AdminPaymentAction.action" method="post" id="AdminPaymentAction"  name="AdminPaymentAction" theme="simple">
                                             <s:hidden name="profileid" value="%{profile.profileid}" />
                                          <div> 
                                            <table border="0" width="600" class="table table-responsive table-striped table-hover table-condensed thumbnail">
                                              <tr>
                                                 <td colspan="3"><h4 class="text-danger text-center thumbnail">Admin Section :</h4></td>
                                              </tr>
                                              <tr>
		 ...
		 <div id="footer" class="row" >	 <!-- Footer Starts-->
							<div id="footerimage" class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 img-responsive img-rounded"><center> <p > Copyright © 2014 MySangathi.com. All rights reserved.</p>
           </center></div>
		 </div>	 <!-- Footer Ends-->
</div>     <!-- Container Ends-->
