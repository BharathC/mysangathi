            ...
            <div id="content" class="row">
                   ...
                   <div class="panel panel-success">
                                          <div class="panel-heading">
                                            <h3 class="panel-title label label-success text-center">Forgot Password </h3>
                                          </div>
                                          <div class="panel-body">
                                       	  <s:form action="ForgotPasswordAction.action" method="post" id="ProfileAction" name= "ProfileAction" theme="simple">
                                            <table class=" table table-responsive "  >
                                                  <tr>
                                                      <td ><h4 class="text-primary">Enter your User Name/Email Address :</h4></td>
                                                      <td>
                                                       <center>
                                                      	<s:textfield id="username"  name="username" label="Enter your  User Name/Email Address" onkeypress="return validateForm()" cssClass="form-control"></s:textfield>
                                                       </center>
                                                      </td>
                                                  </tr>
                                                  <tr>
                                                      <td colspan="2"><center><input type="submit"  value="submit" class="btn btn-success"  onclick="forgotpassword()"></center></td>
                                                  </tr>    
                                           </table>
                                           </s:form>
                                         </div>
				 ...
				 <div id="footer" class="row" >	 <!-- Footer Starts-->
		          ...
		          <center> <p><strong> Copyright &copy; 2014 MySangathi.com. All rights reserved.</strong></p></center>
		          </div>
				 </div>	 <!-- Footer Ends-->
</div>     <!-- Container Ends-->
