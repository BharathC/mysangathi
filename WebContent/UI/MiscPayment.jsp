			...
			<div id="menu" class="row">	<!-- menu Starts-->	
               ...
               <div class="panel panel-success">
                                  <div class="panel-heading">
                                    <h3 class="panel-title text-danger">Miscellaneous Payment</h3>
                                  </div>
                                  <div class="panel-body">
                             <form action="GenerateMiscPayment.action" method="post" id="MiscPayment" name="MiscPayment" >
                             <s:hidden  value="%{#session.myprofile.username}" id="username"  name="username"  />
                               <table  border="1" bordercolor="#99FF99 " class="table table-responsive"  >
                                  <tr>
                                    <td width="200" class="text-primary"><center>Name :</center></td>
                                    <td width="200"><s:textfield id="name"  cssClass="form-control" theme="simple" /></td>
                                  </tr>
                                  <tr>
                                    <td class="text-primary"><center>Email :</center></td>
                                    <td><s:textfield  name="password" id="email" cssClass="form-control" theme="simple"/></td>
                                  </tr>
                                  <tr>
                                    <td class="text-primary"><center>Phone no :</center></td>
                                    <td><s:textfield   id="phone" cssClass="form-control" theme="simple"/></td>
                                  </tr>
                                 <tr>
                                    <td class="text-primary"><center>Payment for :</center></td>
                                    <td><s:select  list="#{'Select':'Select','Horoscope':'Horoscope','MatchMaking':'MatchMaking','MarriageSettle':'MarriageSettle','Other':'Other'}" name="payfor" id="payfor" cssClass="form-control"  theme="simple" ></s:select>
                                    
                                  </tr>
                                  <tr>
                                    <td class="text-primary"><center>Amount :</center></td>
                                    <td><s:textfield   id="amount" cssClass="form-control" theme="simple"/></td>
                                  </tr>
                                  <tr>
                                    <td class="text-primary"><center>Description :</center></td>
                                    <td><s:textarea rows="3"   id="desc" cssClass="form-control" theme="simple"/></td>
                                  </tr>
                                  <tr>
