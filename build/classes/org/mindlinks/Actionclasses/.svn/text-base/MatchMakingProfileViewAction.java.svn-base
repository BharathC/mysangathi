...
public class MatchMakingProfileViewAction extends ActionSupport implements ModelDriven
{
private static final Logger logger = Logger.getLogger(MatchMakingProfileViewAction.class);
