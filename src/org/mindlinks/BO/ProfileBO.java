...
public class ProfileBO
{
	...
	public void profileUpdateInSalesForce(Profile profile)
	{
		...
		// DateTime now = new DateTime();
		// String age = Years.yearsBetween(birthdate, now);
		 profileclient.profileUpdateInSalesForce(profile);
		logger.info("EXIT::THE UPDATE PROFILE BO METHOD");
		//return profile1;
	}
	...
	public void toConvertMysangathiUserToLeads(Profile  profile) throws HttpException, IOException, ServletException, ParseException
	{
		...
		//22profiledao.toConvertMysangathiUserToLeads(profile);
	}
	

	
	public void toUploadProfileToSalesForce(Profile profile) throws HttpException, IOException, ServletException, ParseException
	{
		ProfileDAO profiledao = new ProfileDAO();

		profiledao.toUploadProfileToSalesForce(profile);
	}
